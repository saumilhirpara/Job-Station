            ...
            <header class="main-header header-shaddow">
                <div class="container-fluid">
                    ...
                    <div class="main-box">
                        ...
                        <div class="nav-outer">
                        <div class="logo-box">
                            <div class="logo"><a href="C:\xampp\htdocs\JobStation\index.php"><img src="images/bg_logo.png" alt="" height="90" width="150" title=""></a></div>
                        </div>
                        ...
                        <div class="outer-box">
                            ...
                            <div class="dropdown dashboard-option">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="http://localhost/JobStation/dashboard/employer/post-job.php"><i class="la la-paper-plane"></i>Post a New Job</a></li>
