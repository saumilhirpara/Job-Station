...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Superio | Just another HTML Template | Job List v8</title>
            ...
            <header class="main-header header-shaddow">
                <div class="container-fluid">
                    ...
                    <div class="main-box">
                        ...
                        <div class="nav-outer">
                        <div class="logo-box">
                            <div class="logo"><a href="C:\xampp\htdocs\JobStation\index.php"><img src="images/logo.svg" alt="" title=""></a></div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="job-block-four col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-box">
                                            ...
                                            <span class="company-logo"><img src="images/resource/company-logo/3-5.png" alt=""></span>
                                            <span class="company-name">Catalyst</span>
                                            <h4><a href="#">Software Engineer (Android), Libraries</a></h4>
                                            <div class="location"><span class="icon flaticon-map-locator"></span> London, UK</div>
                                        </div>
                                    ...
                                    <div class="job-block-four col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-box">
                                            ...
                                            <span class="company-logo"><img src="images/resource/company-logo/3-6.png" alt=""></span>
                                            <span class="company-name">Catalyst</span>
                                            <h4><a href="#">Software Engineer (Android), Libraries</a></h4>
                                            <div class="location"><span class="icon flaticon-map-locator"></span> London, UK</div>
                                        </div>
